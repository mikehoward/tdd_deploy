...
class TestEnvironTestCase < Test::Unit::TestCase
  ...
  def test_resonse_to_instance_assessors
    [:env_hash, :ssh_timeout, :site_base_port, :site_num_servers,
      ...
      :site, :site_user, :site_doc_root, :site_url,
  ...
  def test_env_type
    ...
    "site", "site_user", "site_doc_root", "site_url", 'app_hosts', "balance_hosts", "db_hosts", "web_hosts"].each do |sym|
    ...
    ["host_admin", "local_admin", "local_admin_email", "site", "site_user",  "site_doc_root", "site_url"].each do |key|
  ...
  def test_env_hash
    ["ssh_timeout", "site_base_port", "site_num_servers", "host_admin", "local_admin", "local_admin_email",
    "site", "site_user", "site_doc_root", "site_url", 'app_hosts', "balance_hosts", "db_hosts", "web_hosts"].each do |key|
